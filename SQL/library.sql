...
CREATE TABLE `emprunts` (
  ...
  `signalement` boolean NOT NULL DEFAULT 0,
...
INSERT INTO `emprunts` (`id`, `date_emprunt`, `id_utilisateur`, `id_livre`, `signalement`, `description`) VALUES
(1, '2023-11-09 21:54:09', '1', '1', '1', ''),
(2, '2023-11-09 21:59:23', '2', '4', '0', '');
...
ALTER TABLE `emprunts`
  ...
  ALTER TABLE `emprunts`
    ADD CONSTRAINT `fk_emprunts_utilisateurs` FOREIGN KEY (`id_utilisateur`) REFERENCES `utilisateurs` (`id`),
    ADD CONSTRAINT `fk_emprunts_livres` FOREIGN KEY (`id_livre`) REFERENCES `livres` (`id`);
