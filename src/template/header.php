...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="../../src/home/home.php">Librairie XYZ</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="../../src/emprunt/emprunts.php">Emprunts</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../../src/book/books.php">Livres</a>
                    </li>
                    <li class="nav-item">
